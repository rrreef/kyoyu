...
export default function Search() {
  ...
  return (
    <div className="page search-page animate-in" style={{ paddingBottom: keyboardHeight > 0 ? 126 + keyboardHeight - 34 : 126, transition: 'padding-bottom 0.25s cubic-bezier(0.2, 0.8, 0.2, 1)' }}>
